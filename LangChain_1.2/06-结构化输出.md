...
![LangChain Pydantic 结构化输出工作流程](assets/langchain-pydantic-structured-output-workflow.png)
...
![TypedDict 字段错误的 IDE 静态检查示例](assets/typeddict-ide-static-check-example.png)
