...
![从 PC 互联网时代、移动互联网时代到 AI 智能化时代](assets/page001_img001.png)

### 1.2 单一的大语言模型的局限性

![单一的大语言模型的局限性](assets/page001_img002.png)
...
![LangChain 框架的定位](assets/page002_img001.png)
...
![LangChain 广泛适用的核心场景](assets/page002_img002.png)
...
![AI 大模型与 Agent 应用开发架构及岗位映射](assets/page003_img001.png)

应用开发是大模型最值得关注的方向：**应用为王！**

![LangChain 标识](assets/page003_img002.png)

学习 LangChain 框架，高效开发大模型应用。

## 2、LangChain 是什么？

### 2.1 LangChain 的发展时间线

![LangChain GitHub Star 发展曲线](assets/page004_img001.png)
...
![LangChain v0.3 框架问题诊断](assets/page005_img001.png)
...
![LangChain v1.2 核心包与独立供应商包](assets/page007_img001.png)
...
![LangChain Reference API 页面](assets/page008_img001.png)
...
![LangChain 智能体生态全生命周期](assets/page009_img001.png)
...
![LangChain、LangGraph 与 Deep Agents 官方对比说明](assets/page011_img001.png)

三个框架不是竞争关系，并非互斥，复杂项目完全可以同时用到这三层。

**基于 LLM 的应用开发体系图：**

![基于 LLM 的应用开发体系图](assets/page011_img002.png)
...
![LangSmith 可视化监控界面](assets/page012_img001.png)
...
![全局环境与虚拟环境对比](assets/page013_img001.png)
...
安装 conda 环境，见《02资料\尚硅谷-conda使用指南.md》。
...
![conda list 检查包来源](assets/page016_img001.png)

#### 4.2.4 PyCharm 开发环境

PyCharm 作为专业的 Python IDE，具有强大的代码编辑、调试和版本控制功能。

![PyCharm 标识](assets/page016_img002.png)

<https://www.jetbrains.com/pycharm/download/other/#releases-2025>

![PyCharm 2025.3 历史版本下载页面](assets/page017_img001.png)

创建新的工程，并设置 Python 解释器（选择 Anaconda 环境）。

![PyCharm 新建工程并选择 Anaconda 环境](assets/page017_img002.png)
...
![LLM 与 RAG 组合后正确率示意](assets/page018_img001.png)
...
![LangChain RAG 工作流程图](assets/page018_img002.png)

图2：

![RAG 检索增强生成完整流程](assets/page019_rag_workflow.png)

检索-增强-生成过程：检索可以理解为第10步，增强理解为第13步（这里的提示词包含检索到的数据），生成理解为第15步。

![知识更新与知识检索流程](assets/page019_img003.png)
...
![原始人狩猎与钓鱼的决策、记忆和行动类比](assets/page020_img001.png)
...
![秘塔 AI 搜索研究模式](assets/page021_img001.png)

![秘塔 AI 搜索步骤拆解](assets/page021_img002.png)

#### 3、工具使用（Tool Use）

调用外部工具（如 API、数据库）扩展能力边界。

![大模型调用外部工具示意](assets/page021_img003.png)
...
![纯 Prompt 应用场景](assets/page023_img001.png)
...
![Agent 与 Function Calling 应用场景](assets/page024_img001.png)
...
![RAG 应用场景](assets/page024_img002.png)
...
![Fine-tuning 应用场景](assets/page025_img001.png)
...
![大模型应用技术选择流程](assets/page025_img002.png)
